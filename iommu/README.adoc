// -*- mode: adoc-mode; coding: utf-8-unix; indent-tabs-mode: t; ruler-mode-tab-stops: t; tab-width: 4 -*-
...
io/fio:: - Test for running a fio.job against a system with a specific iommu configuration.
