...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#
#   runtest.sh of /kernel/ipmi/sanity/watchdog-sanity-check
#   Description: IPMI Watchdog Sanity Check
...
TEST="/kernel/ipmi/sanity/watchdog-sanity-check"
...
rlJournalStart
    ...
    # Add ipmi_watchdog module, execute ipmi driver test
    rlPhaseStartTest
        rlRun -l "modprobe -v ipmi_watchdog timeout=60"
        rlRun -l "gcc -o simple simple.c"
        rlRun -l "./simple"
    rlPhaseEnd

    rlPhaseStartTest
    # Execute bmc get info in a loop, verify ipmi does not hang
        for i in $(seq 0 10); do
            rlRun -l "ipmitool bmc watchdog get"
            sleep 3
