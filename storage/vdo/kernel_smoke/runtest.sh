...
filter1="--filter=component:vdo|component:kmod-kvdo"
filter2="--filter=tags:kernel_smoke"
setup1="--setup=iscsi"
setup2="--setup=vdo/setup/storage/cleanup_multipath"

command="stqe-test run --fmf $filter1 $filter2 $setup1 $setup2 $ENV_PARAMS"
echo "$command"
