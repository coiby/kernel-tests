...
{
		intptr_t res = 0;
	res = syscall(__NR_socket, /*domain=*/0x10ul, /*type=*/3ul, /*proto=*/0x15);
	if (res != -1)
		r[0] = res;
...
*(uint32_t*)0x200004c0 = 0x10;
*(uint16_t*)0x200004c4 = 0x14;
*(uint16_t*)0x200004c6 = 1;
*(uint32_t*)0x200004c8 = 0x70bd2b;
*(uint32_t*)0x200004cc = 0x25dfdbfc;
*(uint64_t*)0x20000508 = 0x10;
*(uint64_t*)0x20000558 = 1;
*(uint64_t*)0x20000560 = 0;
*(uint64_t*)0x20000568 = 0;
*(uint32_t*)0x20000570 = 0x20040008;
	syscall(__NR_sendmsg, /*fd=*/r[0], /*msg=*/0x20000540ul, /*f=*/0x8800ul);
