...
TEST="networking/tunnel/gre/basic"
...
then
	...
	rlRun "$S_CMD socat tcp4-listen:51110,fork - > server4.log &"
	rlRun "sleep 5"
	...
	rlRun "$S_CMD socat tcp6-listen:51111,fork - > server6.log &"
	rlRun "sleep 5"
	...
	rlRun "$S_CMD socat tcp4-listen:51112,fork - > server4.log &"
	rlRun "sleep 1"
	...
	rlRun "$S_CMD socat tcp6-listen:51113,fork - > server6.log &"
	rlRun "sleep 1"
