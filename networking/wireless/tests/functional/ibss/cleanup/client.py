...
"""
The functional.ibss.cleanup.client module provides a class (Test) that cleans up
an already established IBSS connection.
...
class Test(functional.ibss.functional_ibss_base.FunctionalIbssBaseTest):
    """
    Test tears down an already established IBSS connection.
    ...
    def __init__(self):
        ...
        self.add_test_step(
            test_step = self.teardown_ibss_server,
            test_step_description = 'Have the server teardown the IBSS connection',
