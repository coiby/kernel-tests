...
"""
The functional.radio.radio_toggle.wireless_connection_to_WPA2_TLS_AP
...
class Test(functional.radio.radio_toggle.enterprise_radio_toggle_base.EnterpriseRadioToggleBaseTest):
    ...
    def __init__(self):
        ...
        self.set_test_name(name = '/kernel/wireless_tests/functional/radio/radio_toggle/wireless_connection_to_WPA2_TLS_AP')
        self.set_test_author(name = 'Ken Benoit', email = 'kbenoit@redhat.com')
        self.set_test_description(description = 'Establish a wireless connection to a WPA2 TLS AP and then toggle the wireless radio.')
