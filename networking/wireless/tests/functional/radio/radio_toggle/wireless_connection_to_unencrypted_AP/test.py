...
class Test(functional.radio.radio_toggle.radio_toggle_base.RadioToggleBaseTest):
    ...
    def __init__(self):
        ...
        self.set_test_name(name = '/kernel/wireless_tests/functional/radio/radio_toggle/wireless_connection_to_unencrypted_AP')
        self.set_test_author(name = 'Ken Benoit', email = 'kbenoit@redhat.com')
        self.set_test_description(description = 'Establish a wireless connection to an unencrypted AP and then toggle the wireless radio.')
