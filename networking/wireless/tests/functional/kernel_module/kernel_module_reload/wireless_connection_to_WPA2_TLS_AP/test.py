...
"""
The functional.kernel_module.kernel_module_reload.wireless_connection_to_WPA2_TLS_AP
...
class Test(functional.kernel_module.kernel_module_reload.enterprise_kernel_module_reload_base.EnterpriseKernelModuleReloadBaseTest):
    ...
    def __init__(self):
        ...
        self.set_test_name(name = '/kernel/wireless_tests/functional/kernel_mdoule/kernel_module_reload/wireless_connection_to_WPA2_TLS_AP')
        self.set_test_author(name = 'Ken Benoit', email = 'kbenoit@redhat.com')
        self.set_test_description(description = 'Establish a wireless connection to a WPA2 TLS AP, remove the kernel modules for the wireless interface, insert the kernel modules, and re-establish the connection.')
