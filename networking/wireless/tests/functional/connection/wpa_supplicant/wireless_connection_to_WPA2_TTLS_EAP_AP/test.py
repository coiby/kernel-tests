...
"""
The functional.connection.wpa_supplicant.wireless_connection_to_WPA2_TTLS_EAP_AP
...
class Test(functional.connection.wpa_supplicant.enterprise_connection_base.EnterpriseConnectionBaseTest):
    ...
    def __init__(self):
        ...
        self.set_test_name(name = '/kernel/wireless_tests/functional/connection/wpa_supplicant/wireless_connection_to_WPA2_TTLS_EAP_AP')
        self.set_test_author(name = 'Ken Benoit', email = 'kbenoit@redhat.com')
        self.set_test_description(description = 'Establish a wireless connection to a WPA2 TTLS EAP AP using wpa_supplicant.')
        ...
        self.replace_test_step_description(
            ...
            new_description = 'Configure the test wireless interface with a WPA2 EAP MSCHAPV2 TTLS connection using wpa_supplicant',
        )
