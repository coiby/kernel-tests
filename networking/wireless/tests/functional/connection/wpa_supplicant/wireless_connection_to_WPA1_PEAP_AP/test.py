...
"""
The functional.connection.wpa_supplicant.wireless_connection_to_WPA1_PEAP_AP
...
class Test(functional.connection.wpa_supplicant.enterprise_connection_base.EnterpriseConnectionBaseTest):
    ...
    def __init__(self):
        ...
        self.set_test_name(name = '/kernel/wireless_tests/functional/connection/wpa_supplicant/wireless_connection_to_WPA1_PEAP_AP')
        self.set_test_author(name = 'Ken Benoit', email = 'kbenoit@redhat.com')
        self.set_test_description(description = 'Establish a wireless connection to a WPA1 PEAP AP using wpa_supplicant.')
        ...
        self.replace_test_step_description(
            ...
            new_description = 'Configure the test wireless interface with a WPA1 MSCHAPV2 PEAP connection using wpa_supplicant',
        )

        self.set_ssid(ssid = 'qe-wpa1-enterprise')
        self.set_key_management_type(management_type = 'wpa-eap')
        self.set_eap(eap = 'peap')
