...
"""
The functional.connection.wpa_supplicant.wireless_connection_to_unencrypted_AP
...
class Test(functional.connection.wpa_supplicant.connection_base.ConnectionBaseTest):
    ...
    def __init__(self):
        ...
        self.set_test_name(name = '/kernel/wireless_tests/functional/connection/wpa_supplicant/wireless_connection_to_unencrypted_AP')
        self.set_test_author(name = 'Ken Benoit', email = 'kbenoit@redhat.com')
        self.set_test_description(description = 'Establish a wireless connection to an unencrypted AP using wpa_supplicant.')

        self.replace_test_step_description(
            pattern = 'Configure the test wireless interface',
            new_description = 'Configure the test wireless interface with an open (unencrypted) connection using wpa_supplicant',
        )
