...
"""
The functional.connection.nmcli.connection_base module provides a class
(ConnectionBaseTest) provides the base test steps for all nmcli connection-based
tests.
...
class ConnectionBaseTest(functional.connection.functional_connection_base.FunctionalConnectionBaseTest):
    ...
    def __init__(self):
        ...
        self.add_test_step(
            ...
            test_step_description = 'Configure the test wireless interface using nmcli',
