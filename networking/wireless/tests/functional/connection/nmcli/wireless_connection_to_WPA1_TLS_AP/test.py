...
"""
The functional.connection.nmcli.wireless_connection_to_WPA1_TLS_AP
...
class Test(functional.connection.nmcli.enterprise_connection_base.EnterpriseConnectionBaseTest):
    ...
    def __init__(self):
        ...
        self.set_test_name(name = '/kernel/wireless_tests/functional/connection/nmcli/wireless_connection_to_WPA1_TLS_AP')
        self.set_test_author(name = 'Ken Benoit', email = 'kbenoit@redhat.com')
        self.set_test_description(description = 'Establish a wireless connection to a WPA1 TLS AP using nmcli.')
        ...
        self.replace_test_step_description(
            ...
            new_description = 'Configure the test wireless interface with a WPA1 EAP TLS connection using nmcli',
        )
