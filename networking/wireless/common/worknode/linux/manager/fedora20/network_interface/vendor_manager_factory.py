...
import worknode.linux.manager.network_interface.vendor_manager_factory

class VendorManagerFactory(worknode.linux.manager.network_interface.vendor_manager_factory.VendorManagerFactory):
    """
    ...
    def __init__(self):
        ...
        self.add_module_path(
            path = 'worknode.linux.manager.fedora20.network_interface.vendor_manager',
        )
