...
import worknode.linux.manager.fedora20.audio
from worknode.exception.worknode_executable import *
from constants.time import *

class IntegerSoundcardControl(worknode.linux.manager.fedora20.audio.SoundcardControl):
    """
...
class BooleanSoundcardControl(worknode.linux.manager.fedora20.audio.SoundcardControl):
    """
...
class EnumeratedSoundcardControl(worknode.linux.manager.fedora20.audio.SoundcardControl):
    """
    Class representing a soundcard control that uses integer values.
...
class BytesSoundcardControl(worknode.linux.manager.fedora20.audio.SoundcardControl):
    """
...
class IEC958SoundcardControl(worknode.linux.manager.fedora20.audio.SoundcardControl):
    """
