...
import worknode.linux.manager.rhel6.file.wpa_supplicant_conf
import worknode.linux.manager.rhel6.file.wpa_supplicant_sysconfig
...
class ConfigFileManager(worknode.linux.manager.config_file_base.ConfigFileManager):
    ...
    def __configure_wpa_supplicant_conf(self):
        wpa_supplicant_conf = worknode.linux.manager.rhel6.file.wpa_supplicant_conf.WpaSupplicantConf(
    ...
    def __configure_wpa_supplicant_sysconfig(self):
        wpa_supplicant_sysconfig = worknode.linux.manager.rhel6.file.wpa_supplicant_sysconfig.WpaSupplicantSysconfig(
            work_node = self._get_work_node(),
        )
        self._add_config_file_object(
