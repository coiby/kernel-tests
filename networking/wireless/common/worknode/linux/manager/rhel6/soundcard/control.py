...
import worknode.linux.manager.rhel6.audio
from worknode.exception.worknode_executable import *
from constants.time import *

class IntegerSoundcardControl(worknode.linux.manager.rhel6.audio.SoundcardControl):
    """
...
class BooleanSoundcardControl(worknode.linux.manager.rhel6.audio.SoundcardControl):
    """
...
class EnumeratedSoundcardControl(worknode.linux.manager.rhel6.audio.SoundcardControl):
    """
    Class representing a soundcard control that uses integer values.
...
class BytesSoundcardControl(worknode.linux.manager.rhel6.audio.SoundcardControl):
    """
...
class IEC958SoundcardControl(worknode.linux.manager.rhel6.audio.SoundcardControl):
    """
