...
"""
The worknode.linux.manager.rhel7.minor_versions.rhel70.network module provides a
...
import worknode.linux.manager.rhel7.minor_versions.rhel70.network_interface.vendor_manager_factory
...
class WirelessInterface(worknode.linux.manager.rhel7.network.WirelessInterface):
    """
    WirelessInterface represents a wireless network interface on a RHEL7.0 work
    node.
    ...
    def __init__(self, parent, name):
        ...
        self._set_vendor_manager_factory(
            factory = worknode.linux.manager.rhel7.minor_versions.rhel70.network_interface.vendor_manager_factory.VendorManagerFactory(),
        )

class WiredInterface(worknode.linux.manager.rhel7.network.WiredInterface):
    """
    WiredInterface represents a wired network interface on a RHEL7.0 work node.
