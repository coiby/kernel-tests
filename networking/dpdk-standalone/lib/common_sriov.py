...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#
#   common_sriov.py of kernel/networking/dpdk-standalone
...
class COMMON_SRIOV(SRIOV):
    ...
    def get_all_vf_list_from_pf_bus( pf_bus):
        ...
        for vf_name_path in all_vf_name_path:
            if local.path(vf_name_path).exists():
    ...
    def create_vfs( pf_bus, num):
        ...
        ip link show {pf_name}
        echo 0 > /sys/bus/pci/devices/{pf_bus}/sriov_numvfs
        echo 1 > /sys/bus/pci/devices/{pf_bus}/sriov_numvfs
        """
