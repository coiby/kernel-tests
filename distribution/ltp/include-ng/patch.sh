...
patch-rtltp()
{
	...
	patch -d ${TARGET} -p1 < ${ABS_DIR}/${TESTVERSION}/0001-Create-missing-log-directory-for-realtime-perf-laten.patch
	patch -d ${TARGET} -p1 < ${ABS_DIR}/${TESTVERSION}/0002-Enhance-log-checking-for-realtime-perf-latency.patch
}
