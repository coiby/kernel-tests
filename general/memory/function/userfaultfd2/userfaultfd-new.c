...
static void userfaultfd_pagemap_test(unsigned int test_pgsize)
{
	...
	if (test_pgsize > page_size) {
		/* This is a thp test */
		if (madvise(area_dst, nr_pages * page_size, MADV_HUGEPAGE) && getenv("thp_support")!=NULL)
			err("madvise(MADV_HUGEPAGE) failed");
	} else if (test_pgsize == page_size) {
		/* This is normal page test; force no thp */
		if (madvise(area_dst, nr_pages * page_size, MADV_NOHUGEPAGE) && getenv("thp_support")!=NULL)
