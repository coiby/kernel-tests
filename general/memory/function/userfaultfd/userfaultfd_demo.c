...
Source: http://www.man7.org/linux/man-pages/man2/userfaultfd.2.html
...
int main(int argc, char *argv[])
{
    ...
    l = 0xf;    /* Ensure that faulting address is not on a page
                   ...
                   handle that case in fault_handler_thread() */
    while (l < len) {
        char c = addr[l];
...
#else  //  "__NR_userfaultfd" is not defined.

int main(int argc, char *argv[])
{
  printf("Skip test, userfaultfd not implemented.\n");
  exit(EXIT_SUCCESS);
}
