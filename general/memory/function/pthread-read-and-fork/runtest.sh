...
mkdir -p /var/tmp
OUTPUTFILE=`mktemp /var/tmp/tmp.XXXXXX`
TestHeader
...
mkdir -p /var/huge
mount -t hugetlbfs hugetlbfs /var/huge
...
rstrnt-report-result "/kernel/general/memory/function/pthread-read-and-fork" PASS
